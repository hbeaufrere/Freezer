...
CREATE TABLE IF NOT EXISTS shelves (
    ...
    position    INTEGER NOT NULL UNIQUE,     -- 1=upper, 2=middle, 3=lower
    section     TEXT NOT NULL DEFAULT 'research'  -- 'raptor' or 'research'
);
...
CREATE TABLE IF NOT EXISTS research_tubes (
    ...
    row_pos         INTEGER NOT NULL,        -- 1-based row in box grid
    col_pos         INTEGER NOT NULL,        -- 1-based column in box grid
